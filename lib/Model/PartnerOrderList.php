...
class PartnerOrderList implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'resources' => '\EzzeSiftuz\OrdersV2\Model\PartnerOrder[]',
...
'links' => 'getLinks'    ];
     ...
     * Sets resources
     *
     * @param \EzzeSiftuz\OrdersV2\Model\PartnerOrder[] $resources The list of queried resources. In this case partner orders.
     *
     * @return $this
     */
     ...
     * Sets links
     *
     * @param \EzzeSiftuz\OrdersV2\Model\Link[] $links Links related to the list. E.g. the link to the successive list used during paging.
     *
     * @return $this
     */
